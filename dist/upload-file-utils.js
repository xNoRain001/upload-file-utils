    ...
    _createClass(Uploader, [{
      ...
      value: function formdata() {
        ...
        var file = options.file,
            ...
            filename = _options$filename === void 0 ? file.name : _options$filename,
            url = options.url,
            ...
            failed = _options$failed === void 0 ? noop : _options$failed,
            _options$finally = options["finally"],
            last = _options$finally === void 0 ? noop : _options$finally;
        var formData = new FormData();
        formData.append('file', file);
        formData.append('filename', filename);
        beforeStart(); // read to upload

        request.post(url, formData).then(function (response) {
